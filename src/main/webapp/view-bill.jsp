...
<head>
    ...
    <title>View Bill - Pahana Edu Billing System</title>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <div>
                ...
                <a href="edit-bill?id=${bill.id}" class="btn btn-primary">
        ...
        <div class="invoice-container">
            ...
            <div class="invoice-header">
                ...
                <div class="invoice-details">
                    ...
                    <div class="invoice-status status-${bill.status.toLowerCase()}">
                        ${bill.status}
                    </div>
                </div>
            </div>
            ...
            <div class="customer-section">
                ...
                <div class="bill-info">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">${bill.createdBy}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="actions-section">
                ...
                <div>
                    <c:if test="${bill.status == 'PENDING'}">
                        <a href="edit-bill?id=${bill.id}" class="btn btn-success">
